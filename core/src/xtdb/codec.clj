...
(def id-value-type-id 0)
(def object-value-type-id 1)
(def clob-value-type-id 2)
(def nil-value-type-id 3)
(def boolean-value-type-id 4)
(def long-value-type-id 5)
(def double-value-type-id 6)
(def date-value-type-id 7)
(def string-value-type-id 8)
(def char-value-type-id 9)
(def nippy-value-type-id 10)
(def bigdec-value-type-id 11)
(def bigint-value-type-id 12)
(def biginteger-value-type-id 13)
(def localdate-value-type-id 14)
(def localtime-value-type-id 15)
(def localdatetime-value-type-id 16)
(def instant-value-type-id 17)
(def duration-value-type-id 18)
