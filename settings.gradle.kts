...
include("modules:kafka", "modules:kafka-connect", "modules:postgres-source", "modules:sqlite-source", "modules:aws", "modules:azure", "modules:google-cloud")
...
project(":modules:sqlite-source").name = "xtdb-sqlite-source"
